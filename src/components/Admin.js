      ...
      <section className="admin-shell">
        ...
        {dashboard && (
          <>
            ...
            <section className="admin-analytics-note">
              <p>
                <i className="fas fa-chart-line"></i>
                Website analytics powered by <strong>Yandex Metrica</strong>
                <br />
                <small>View detailed reports at <a href="https://metrica.yandex.com" target="_blank" rel="noreferrer">metrica.yandex.com</a></small>
              </p>
            </section>
